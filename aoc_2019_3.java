...
class Scratch {
    ...
    static int processInput(String path1, String path2) {
        ...
        Set<Node> path1Nodes = pathParser(path1, entryNode);
        Set<Node> path2Nodes = pathParser(path2, entryNode);
    ...
    private static Set<Node> pathParser(String path, Node entryNode) {
        int x = entryNode.x;
        int y = entryNode.y;
